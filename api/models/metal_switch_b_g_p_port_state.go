...
// Validate validates this metal switch b g p port state
...
func (m *MetalSwitchBGPPortState) validateAcceptedPrefixCounter(formats strfmt.Registry) error {
...
func (m *MetalSwitchBGPPortState) validateBgpState(formats strfmt.Registry) error {
...
func (m *MetalSwitchBGPPortState) validateBgpTimerUpEstablished(formats strfmt.Registry) error {
...
func (m *MetalSwitchBGPPortState) validateNeighbor(formats strfmt.Registry) error {
...
func (m *MetalSwitchBGPPortState) validatePeerGroup(formats strfmt.Registry) error {
...
func (m *MetalSwitchBGPPortState) validateSentPrefixCounter(formats strfmt.Registry) error {
...
func (m *MetalSwitchBGPPortState) validateVrfName(formats strfmt.Registry) error {
...
func (m *MetalSwitchBGPPortState) UnmarshalBinary(b []byte) error {
	var res MetalSwitchBGPPortState

...
// ContextValidate validate this v1 machine hardware extended based on the context it is used
func (m *V1MachineHardwareExtended) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1MachineHardwareExtended) contextValidateDisks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1MachineHardwareExtended) contextValidateNics(ctx context.Context, formats strfmt.Registry) error {

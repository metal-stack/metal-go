...
func (o *CreateSizeImageConstraintCreated) Error() string {
	return fmt.Sprintf("[PUT /v1/sizeimageconstraint/sizeimageconstraints][%d] createSizeImageConstraintCreated  %+v", 201, o.Payload)
}
...
func (o *CreateSizeImageConstraintConflict) Error() string {
	return fmt.Sprintf("[PUT /v1/sizeimageconstraint/sizeimageconstraints][%d] createSizeImageConstraintConflict  %+v", 409, o.Payload)
}
...
func (o *CreateSizeImageConstraintDefault) Error() string {
	return fmt.Sprintf("[PUT /v1/sizeimageconstraint/sizeimageconstraints][%d] createSizeImageConstraint default  %+v", o._statusCode, o.Payload)
}

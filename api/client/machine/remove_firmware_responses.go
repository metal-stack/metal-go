...
func (o *RemoveFirmwareOK) Error() string {
	return fmt.Sprintf("[DELETE /v1/machine/remove-firmware/{kind}/{vendor}/{board}/{revision}][%d] removeFirmwareOK ", 200)
}
...
func (o *RemoveFirmwareDefault) Error() string {
	return fmt.Sprintf("[DELETE /v1/machine/remove-firmware/{kind}/{vendor}/{board}/{revision}][%d] removeFirmware default  %+v", o._statusCode, o.Payload)
}

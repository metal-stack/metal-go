...
func (o *UploadFirmwareOK) Error() string {
	return fmt.Sprintf("[PUT /v1/machine/upload-firmware/{kind}/{vendor}/{board}/{revision}][%d] uploadFirmwareOK ", 200)
}
...
func (o *UploadFirmwareDefault) Error() string {
	return fmt.Sprintf("[PUT /v1/machine/upload-firmware/{kind}/{vendor}/{board}/{revision}][%d] uploadFirmware default  %+v", o._statusCode, o.Payload)
}

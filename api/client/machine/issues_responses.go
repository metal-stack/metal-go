...
func (o *IssuesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		result := NewIssuesDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *IssuesOK) Error() string {
	return fmt.Sprintf("[POST /v1/machine/issues/evaluate][%d] issuesOK  %+v", 200, o.Payload)
}
...
func (o *IssuesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *IssuesDefault) Error() string {
	return fmt.Sprintf("[POST /v1/machine/issues/evaluate][%d] issues default  %+v", o._statusCode, o.Payload)
}
...
func (o *IssuesDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

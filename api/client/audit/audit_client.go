...
func (a *Client) FindAuditTraces(params *FindAuditTracesParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*FindAuditTracesOK, error) {
	...
	if params == nil {
		params = NewFindAuditTracesParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "findAuditTraces",
		Method:             "POST",
		PathPattern:        "/v1/audit/find",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &FindAuditTracesReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*FindAuditTracesOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*FindAuditTracesDefault)

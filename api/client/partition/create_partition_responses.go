...
func (o *CreatePartitionConflict) GetPayload() *models.HttperrorsHTTPErrorResponse {
	return o.Payload
}
...
func (o *CreatePartitionDefault) GetPayload() *models.HttperrorsHTTPErrorResponse {
	return o.Payload
}

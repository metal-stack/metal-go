...
func (o *UpdateSizeImageConstraintOK) Error() string {
	return fmt.Sprintf("[POST /v1/size/sizeimageconstraints][%d] updateSizeImageConstraintOK  %+v", 200, o.Payload)
}
...
func (o *UpdateSizeImageConstraintConflict) Error() string {
	return fmt.Sprintf("[POST /v1/size/sizeimageconstraints][%d] updateSizeImageConstraintConflict  %+v", 409, o.Payload)
}
...
func (o *UpdateSizeImageConstraintDefault) Error() string {
	return fmt.Sprintf("[POST /v1/size/sizeimageconstraints][%d] updateSizeImageConstraint default  %+v", o._statusCode, o.Payload)
}

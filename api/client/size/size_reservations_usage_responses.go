...
func (o *SizeReservationsUsageReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewSizeReservationsUsageOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewSizeReservationsUsageDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewSizeReservationsUsageOK() *SizeReservationsUsageOK {
	return &SizeReservationsUsageOK{}
}
...
func (o *SizeReservationsUsageOK) Error() string {
	return fmt.Sprintf("[POST /v1/size/reservations/usage][%d] sizeReservationsUsageOK  %+v", 200, o.Payload)
}
...
func (o *SizeReservationsUsageOK) GetPayload() []*models.V1SizeReservationUsageResponse {
	return o.Payload
}

func (o *SizeReservationsUsageOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewSizeReservationsUsageDefault(code int) *SizeReservationsUsageDefault {
	return &SizeReservationsUsageDefault{
		_statusCode: code,
	}
}
...
func (o *SizeReservationsUsageDefault) Code() int {
	return o._statusCode
}

func (o *SizeReservationsUsageDefault) Error() string {
	return fmt.Sprintf("[POST /v1/size/reservations/usage][%d] sizeReservationsUsage default  %+v", o._statusCode, o.Payload)
}

func (o *SizeReservationsUsageDefault) String() string {
	return fmt.Sprintf("[POST /v1/size/reservations/usage][%d] sizeReservationsUsage default  %+v", o._statusCode, o.Payload)
}

func (o *SizeReservationsUsageDefault) GetPayload() *httperrors.HTTPErrorResponse {
	return o.Payload
}

func (o *SizeReservationsUsageDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

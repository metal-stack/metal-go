...
// NewGetSizeReservationParams creates a new GetSizeReservationParams object,
...
func NewGetSizeReservationParams() *GetSizeReservationParams {
	return &GetSizeReservationParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetSizeReservationParamsWithTimeout creates a new GetSizeReservationParams object
...
// NewGetSizeReservationParamsWithContext creates a new GetSizeReservationParams object
...
// NewGetSizeReservationParamsWithHTTPClient creates a new GetSizeReservationParams object
...
func (o *GetSizeReservationParams) WithDefaults() *GetSizeReservationParams {
	o.SetDefaults()
	return o
}
...
func (o *GetSizeReservationParams) WithTimeout(timeout time.Duration) *GetSizeReservationParams {
...
func (o *GetSizeReservationParams) WithContext(ctx context.Context) *GetSizeReservationParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetSizeReservationParams) WithID(id string) *GetSizeReservationParams {
	o.SetID(id)
	return o
}
...
func (o *GetSizeReservationParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

...
func (o *ListSizeImageConstraintsOK) Error() string {
	return fmt.Sprintf("[GET /v1/size/sizeimageconstraints][%d] listSizeImageConstraintsOK  %+v", 200, o.Payload)
}
...
func (o *ListSizeImageConstraintsDefault) Error() string {
	return fmt.Sprintf("[GET /v1/size/sizeimageconstraints][%d] listSizeImageConstraints default  %+v", o._statusCode, o.Payload)
}

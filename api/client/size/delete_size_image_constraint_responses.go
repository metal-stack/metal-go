...
func (o *DeleteSizeImageConstraintOK) Error() string {
	return fmt.Sprintf("[DELETE /v1/size/sizeimageconstraints/{id}][%d] deleteSizeImageConstraintOK  %+v", 200, o.Payload)
}
...
func (o *DeleteSizeImageConstraintDefault) Error() string {
	return fmt.Sprintf("[DELETE /v1/size/sizeimageconstraints/{id}][%d] deleteSizeImageConstraint default  %+v", o._statusCode, o.Payload)
}

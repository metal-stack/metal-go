...
func (o *AllocateNetworkConflict) GetPayload() *models.HttperrorsHTTPErrorResponse {
	return o.Payload
}
...
func (o *AllocateNetworkDefault) GetPayload() *models.HttperrorsHTTPErrorResponse {
	return o.Payload
}

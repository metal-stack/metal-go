...
func (_m *ClientService) DeleteSwitch(params *clientswitch_operations.DeleteSwitchParams, authInfo runtime.ClientAuthInfoWriter, opts ...clientswitch_operations.ClientOption) (*clientswitch_operations.DeleteSwitchOK, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(*clientswitch_operations.DeleteSwitchParams, runtime.ClientAuthInfoWriter, ...clientswitch_operations.ClientOption) (*clientswitch_operations.DeleteSwitchOK, error)); ok {
...
func (_m *ClientService) FindSwitch(params *clientswitch_operations.FindSwitchParams, authInfo runtime.ClientAuthInfoWriter, opts ...clientswitch_operations.ClientOption) (*clientswitch_operations.FindSwitchOK, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(*clientswitch_operations.FindSwitchParams, runtime.ClientAuthInfoWriter, ...clientswitch_operations.ClientOption) (*clientswitch_operations.FindSwitchOK, error)); ok {
		return rf(params, authInfo, opts...)
	}
...
func (_m *ClientService) FindSwitches(params *clientswitch_operations.FindSwitchesParams, authInfo runtime.ClientAuthInfoWriter, opts ...clientswitch_operations.ClientOption) (*clientswitch_operations.FindSwitchesOK, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(*clientswitch_operations.FindSwitchesParams, runtime.ClientAuthInfoWriter, ...clientswitch_operations.ClientOption) (*clientswitch_operations.FindSwitchesOK, error)); ok {
		return rf(params, authInfo, opts...)
	}
...
func (_m *ClientService) ListSwitches(params *clientswitch_operations.ListSwitchesParams, authInfo runtime.ClientAuthInfoWriter, opts ...clientswitch_operations.ClientOption) (*clientswitch_operations.ListSwitchesOK, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(*clientswitch_operations.ListSwitchesParams, runtime.ClientAuthInfoWriter, ...clientswitch_operations.ClientOption) (*clientswitch_operations.ListSwitchesOK, error)); ok {
		return rf(params, authInfo, opts...)
	}
...
// MigrateSwitch provides a mock function with given fields: params, authInfo, opts
func (_m *ClientService) MigrateSwitch(params *clientswitch_operations.MigrateSwitchParams, authInfo runtime.ClientAuthInfoWriter, opts ...clientswitch_operations.ClientOption) (*clientswitch_operations.MigrateSwitchOK, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *clientswitch_operations.MigrateSwitchOK
	var r1 error
	if rf, ok := ret.Get(0).(func(*clientswitch_operations.MigrateSwitchParams, runtime.ClientAuthInfoWriter, ...clientswitch_operations.ClientOption) (*clientswitch_operations.MigrateSwitchOK, error)); ok {
		return rf(params, authInfo, opts...)
	}
	if rf, ok := ret.Get(0).(func(*clientswitch_operations.MigrateSwitchParams, runtime.ClientAuthInfoWriter, ...clientswitch_operations.ClientOption) *clientswitch_operations.MigrateSwitchOK); ok {
		r0 = rf(params, authInfo, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*clientswitch_operations.MigrateSwitchOK)
		}
	}

	if rf, ok := ret.Get(1).(func(*clientswitch_operations.MigrateSwitchParams, runtime.ClientAuthInfoWriter, ...clientswitch_operations.ClientOption) error); ok {
		r1 = rf(params, authInfo, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *ClientService) NotifySwitch(params *clientswitch_operations.NotifySwitchParams, authInfo runtime.ClientAuthInfoWriter, opts ...clientswitch_operations.ClientOption) (*clientswitch_operations.NotifySwitchOK, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(*clientswitch_operations.NotifySwitchParams, runtime.ClientAuthInfoWriter, ...clientswitch_operations.ClientOption) (*clientswitch_operations.NotifySwitchOK, error)); ok {
		return rf(params, authInfo, opts...)
	}
...
func (_m *ClientService) RegisterSwitch(params *clientswitch_operations.RegisterSwitchParams, authInfo runtime.ClientAuthInfoWriter, opts ...clientswitch_operations.ClientOption) (*clientswitch_operations.RegisterSwitchOK, *clientswitch_operations.RegisterSwitchCreated, error) {
	...
	var r2 error
	if rf, ok := ret.Get(0).(func(*clientswitch_operations.RegisterSwitchParams, runtime.ClientAuthInfoWriter, ...clientswitch_operations.ClientOption) (*clientswitch_operations.RegisterSwitchOK, *clientswitch_operations.RegisterSwitchCreated, error)); ok {
		return rf(params, authInfo, opts...)
	}
...
func (_m *ClientService) UpdateSwitch(params *clientswitch_operations.UpdateSwitchParams, authInfo runtime.ClientAuthInfoWriter, opts ...clientswitch_operations.ClientOption) (*clientswitch_operations.UpdateSwitchOK, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(*clientswitch_operations.UpdateSwitchParams, runtime.ClientAuthInfoWriter, ...clientswitch_operations.ClientOption) (*clientswitch_operations.UpdateSwitchOK, error)); ok {
		return rf(params, authInfo, opts...)
	}

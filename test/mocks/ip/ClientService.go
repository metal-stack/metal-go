...
func (_m *ClientService) FreeIPDeprecated(params *ip.FreeIPDeprecatedParams, authInfo runtime.ClientAuthInfoWriter, opts ...ip.ClientOption) (*ip.FreeIPDeprecatedOK, error) {
	...
	var r0 *ip.FreeIPDeprecatedOK
	if rf, ok := ret.Get(0).(func(*ip.FreeIPDeprecatedParams, runtime.ClientAuthInfoWriter, ...ip.ClientOption) *ip.FreeIPDeprecatedOK); ok {
		r0 = rf(params, authInfo, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*ip.FreeIPDeprecatedOK)
		}
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(*ip.FreeIPDeprecatedParams, runtime.ClientAuthInfoWriter, ...ip.ClientOption) error); ok {
		r1 = rf(params, authInfo, opts...)
	} else {
		r1 = ret.Error(1)
	}

...
func (_m *ClientService) AddProvisioningEvents(params *machine.AddProvisioningEventsParams, authInfo runtime.ClientAuthInfoWriter, opts ...machine.ClientOption) (*machine.AddProvisioningEventsOK, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *machine.AddProvisioningEventsOK
	if rf, ok := ret.Get(0).(func(*machine.AddProvisioningEventsParams, runtime.ClientAuthInfoWriter, ...machine.ClientOption) *machine.AddProvisioningEventsOK); ok {
		r0 = rf(params, authInfo, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*machine.AddProvisioningEventsOK)
		}
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(*machine.AddProvisioningEventsParams, runtime.ClientAuthInfoWriter, ...machine.ClientOption) error); ok {
		r1 = rf(params, authInfo, opts...)
	} else {
		r1 = ret.Error(1)
	}

...
func (_mock *ClientService) GetMe(params *user.GetMeParams, authInfo runtime.ClientAuthInfoWriter, opts ...user.ClientOption) (*user.GetMeOK, error) {
	...
	var r0 *user.GetMeOK
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(*user.GetMeParams, runtime.ClientAuthInfoWriter, ...user.ClientOption) (*user.GetMeOK, error)); ok {
		return returnFunc(params, authInfo, opts...)
	}
	if returnFunc, ok := ret.Get(0).(func(*user.GetMeParams, runtime.ClientAuthInfoWriter, ...user.ClientOption) *user.GetMeOK); ok {
	...
	if returnFunc, ok := ret.Get(1).(func(*user.GetMeParams, runtime.ClientAuthInfoWriter, ...user.ClientOption) error); ok {
...
type ClientService_GetMe_Call struct {
	*mock.Call
}
...
func (_e *ClientService_Expecter) GetMe(params interface{}, authInfo interface{}, opts ...interface{}) *ClientService_GetMe_Call {
	return &ClientService_GetMe_Call{Call: _e.mock.On("GetMe",
...
func (_c *ClientService_GetMe_Call) Run(run func(params *user.GetMeParams, authInfo runtime.ClientAuthInfoWriter, opts ...user.ClientOption)) *ClientService_GetMe_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 *user.GetMeParams
		if args[0] != nil {
			arg0 = args[0].(*user.GetMeParams)
		}
		var arg1 runtime.ClientAuthInfoWriter
		if args[1] != nil {
			arg1 = args[1].(runtime.ClientAuthInfoWriter)
		}
		var arg2 []user.ClientOption
		var variadicArgs []user.ClientOption
		if len(args) > 2 {
			variadicArgs = args[2].([]user.ClientOption)
		}
		arg2 = variadicArgs
		run(
			arg0,
